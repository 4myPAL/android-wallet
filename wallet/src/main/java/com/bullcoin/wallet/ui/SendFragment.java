...
import com.bullcoin.core.coins.FiatType;
import com.bullcoin.core.coins.Value;
import com.bullcoin.core.coins.ValueType;
...
import com.bullcoin.core.messages.MessageFactory;
import com.bullcoin.core.messages.TxMessage;
import com.bullcoin.core.uri.CoinURI;
import com.bullcoin.core.uri.CoinURIParseException;
import com.bullcoin.core.util.ExchangeRate;
import com.bullcoin.core.util.GenericUtils;
import com.bullcoin.core.wallet.WalletAccount;
import com.bullcoin.core.wallet.exceptions.NoSuchPocketException;
import com.bullcoin.wallet.AddressBookProvider;
...
import com.bullcoin.wallet.tasks.MarketInfoPollTask;
import com.bullcoin.wallet.ui.widget.AddressView;
import com.bullcoin.wallet.ui.widget.AmountEditView;
import com.bullcoin.wallet.util.ThrottlingWalletChangeListener;
import com.bullcoin.wallet.util.UiUtils;
...
import static com.bullcoin.core.coins.Value.canCompare;
import static com.bullcoin.wallet.ExchangeRatesProvider.getRates;
import static com.bullcoin.wallet.util.UiUtils.setGone;
import static com.bullcoin.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, com.bullcoin.core.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
