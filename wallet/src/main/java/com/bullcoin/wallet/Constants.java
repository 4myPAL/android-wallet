...
import com.bullcoin.core.coins.NewCoinMain;
import com.bullcoin.core.coins.BitcoinMain;
import com.bullcoin.core.coins.CoinID;
import com.bullcoin.core.coins.CoinType;
import com.bullcoin.core.coins.LitecoinMain;
import com.bullcoin.core.network.CoinAddress;
import com.bullcoin.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com.bullcoin/Coinomi-android/releases";

    public static final String VERSION_URL = "http://127.0.0.1";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
	        new CoinAddress(NewCoinMain.get(),      new ServerAddress("electrum0.bullcoin.in", 23005),
                    new ServerAddress("electrum1.bullcoin.in", 23005),
                    new ServerAddress("electrum2.bullcoin.in", 23005),
                    new ServerAddress("electrum3.bullcoin.in", 23005),
                    new ServerAddress("electrum4.bullcoin.in", 23005),
                    new ServerAddress("electrum5.bullcoin.in", 23005),
                    new ServerAddress("electrum6.bullcoin.in", 23005),
                    new ServerAddress("electrum7.bullcoin.in", 23005),
                    new ServerAddress("electrum8.bullcoin.in", 23005),
                    new ServerAddress("electrum9.bullcoin.in", 23005),
                    new ServerAddress("electrum10.bullcoin.in", 23005),
                    new ServerAddress("electrum11.bullcoin.in", 23005),
                    new ServerAddress("electrum12.bullcoin.in", 23005),
                    new ServerAddress("electrum13.bullcoin.in", 23005),
                    new ServerAddress("electrum14.bullcoin.in", 23005),
                    new ServerAddress("electrum15.bullcoin.in", 23005),
                    new ServerAddress("electrum16.bullcoin.in", 23005),
                    new ServerAddress("electrum17.bullcoin.in", 23005),
                    new ServerAddress("electrum18.bullcoin.in", 23005),
                    new ServerAddress("electrum19.bullcoin.in", 23005),
                    new ServerAddress("electrum20.bullcoin.in", 23005),
                    new ServerAddress("electrum21.bullcoin.in", 23005),
                    new ServerAddress("electrum22.bullcoin.in", 23005),
                    new ServerAddress("electrum23.bullcoin.in", 23005),
                    new ServerAddress("electrum24.bullcoin.in", 23005)),
