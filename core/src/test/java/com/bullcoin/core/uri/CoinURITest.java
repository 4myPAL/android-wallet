...
import com.bullcoin.core.coins.BitcoinTest;
import com.bullcoin.core.coins.CoinType;
import com.bullcoin.core.coins.DashMain;
...
import com.bullcoin.core.coins.NuSharesMain;
...
//        assertEquals(BTC, uri.getType());
    ...
    public void testAddressRequest() throws Exception {
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://bullcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://bullcoin.com?address=" + MAINNET_GOOD_ADDRESS,
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://bullcoin.com/some-path?abc=xyz", uri.getAddressRequestUri().toString());
        assertEquals("https://bullcoin.com/some-path?abc=xyz&address=" + MAINNET_GOOD_ADDRESS,
                uri.getAddressRequestUriResponse(MAINNET_GOOD_ADDRESS).toString());
        ...
        assertEquals("https://bullcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://bullcoin.com?address=" + goodAddressStr,
